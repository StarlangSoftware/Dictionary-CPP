...
TEST_CASE("DictionaryTest-testGetWordIndex") {
...
TEST_CASE("DictionaryTest-testSize") {
    TxtDictionary lowerCaseDictionary = TxtDictionary("lowercase.txt", Comparator::TURKISH, "turkish_misspellings.txt");
    TxtDictionary mixedCaseDictionary = TxtDictionary("mixedcase.txt", Comparator::TURKISH_NO_CASE,
...
TEST_CASE("DictionaryTest-testLongestWordSize") {
    TxtDictionary lowerCaseDictionary = TxtDictionary("lowercase.txt", Comparator::TURKISH, "turkish_misspellings.txt");
    TxtDictionary mixedCaseDictionary = TxtDictionary("mixedcase.txt", Comparator::TURKISH_NO_CASE,
                                                      "turkish_misspellings.txt");
    TxtDictionary dictionary = TxtDictionary();
...
TEST_CASE("DictionaryTest-testGetWordStartingWith") {
    TxtDictionary lowerCaseDictionary = TxtDictionary("lowercase.txt", Comparator::TURKISH, "turkish_misspellings.txt");
    TxtDictionary mixedCaseDictionary = TxtDictionary("mixedcase.txt", Comparator::TURKISH_NO_CASE,
                                                      "turkish_misspellings.txt");
